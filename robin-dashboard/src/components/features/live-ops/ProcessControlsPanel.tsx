            ...
            <CardBody className="space-y-3">
                ...
                <div className="rounded-xl border border-slate-200 bg-white p-3 dark:border-slate-800 dark:bg-slate-950">
                    ...
                    <div className="mt-2 text-xs text-slate-600 dark:text-slate-400">
                        {isParameterMode
                            ? 'Parameter-driven: set process parameters, then monitor measured geometry against AI-predicted geometry.'
                            : 'Geometry-driven: set target geometry, let AI suggest parameters, then monitor measured geometry against the expected result.'}
                    </div>
                </div>
